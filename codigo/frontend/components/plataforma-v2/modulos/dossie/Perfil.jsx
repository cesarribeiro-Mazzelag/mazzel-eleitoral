...
/* Dossie 09 - Perfil (biografia, redes, contato).
 * Adaptado de designer/section-perfil.jsx. */
...
function SocialCard({ r }) {
  const iconName = SOCIAL_ICON[r.rede] || "Instagram";
  return (
    <div
...
export function Perfil({ profile }) {
            ...
            >
              ...
              <div className="space-y-1.5">
                <div className="flex items-start gap-2 text-[12px]">
                  <Icon name="Briefcase" size={12} className="mt-0.5" style={{ color: "var(--fg-dim)" }} />
