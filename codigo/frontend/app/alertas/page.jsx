...
/**
 * Página de Alertas
 * - Lista alertas com filtros por gravidade e status de leitura
 * - Marcar lido individualmente ou todos de uma vez
 * - Gerar alertas automáticos (PRESIDENTE/DIRETORIA)
 */
...
export default function AlertasPage() {
  ...
  // Filtros
  const [filtroLido, setFiltroLido] = useState("nao_lido"); // "todos" | "nao_lido" | "lido"
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="relative">
            ...
            >
              {GRAVIDADES.map((g) => (
                <option key={g} value={g}>{GRAVIDADE_LABELS[g]}</option>
              ))}
            </select>
          </div>
        </div>
        ...
        {carregando ? (
          ...
          <div className="text-center py-20 text-gray-400">
            ...
            <p className="text-sm mt-1">
              {podeGerar
                ? "Clique em \"Gerar alertas\" para analisar o farol."
                : "Volte mais tarde para verificar novos alertas."}
            </p>
          </div>
        ) : (
          <div className="space-y-3">
